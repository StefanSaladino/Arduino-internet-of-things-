...
//onTime == 142, will take ~ 1 second to complete all 7 colours
int RGBRedPin = 9;
int RGBGreenPin = 10;
int RGBBluePin = 11;
int onTime= 143;
...
//i.e. 143*7*1 = 1001 OR ~ 1 second on thr first loop
...
delay(onTime*i); //wait 143 seconds * value of i in loop
